...
(function (Kunde) {
    ...
    function hideToppingUndEisButtons() {
        document.getElementById("SchokoTopping").disabled = true;
        document.getElementById("ErdbeerTopping").disabled = true;
        document.getElementById("NoTopping").disabled = true;
        document.getElementById("EisSchoko").disabled = true;
        document.getElementById("EisErdbeere").disabled = true;
        document.getElementById("EisVanille").disabled = true;
        document.getElementById("EisHeidelbeere").disabled = true;
        document.getElementById("EisHaselnuss").disabled = true;
        document.getElementById("ButtonsKugel2").hidden = true;
        document.getElementById("k2Yes").disabled = true;
        document.getElementById("k2No").disabled = true;
        document.getElementById("bestellungHinzufuegen").disabled = true;
    }
    function showToppingButtons() {
        document.getElementById("SchokoTopping").disabled = false;
        document.getElementById("ErdbeerTopping").disabled = false;
        document.getElementById("NoTopping").disabled = false;
    }
    function showEisButtons() {
        document.getElementById("EisSchoko").disabled = false;
        document.getElementById("EisErdbeere").disabled = false;
        document.getElementById("EisVanille").disabled = false;
        document.getElementById("EisHeidelbeere").disabled = false;
        document.getElementById("EisHaselnuss").disabled = false;
        preisEiskugel = 1.10;
    }
    function showEis2Buttons() {
        document.getElementById("EisSchoko2").disabled = false;
        document.getElementById("EisErdbeere2").disabled = false;
        document.getElementById("EisVanille2").disabled = false;
        document.getElementById("EisHeidelbeere2").disabled = false;
        document.getElementById("EisHaselnuss2").disabled = false;
        document.getElementById("k2Yes").disabled = false;
        document.getElementById("k2No").disabled = false;
    }
    //Topping
    ...
    function handleToppingSchoko(_eventSetTopping) {
        ...
        preisTopping = 1;
        produktPreisBerechnen();
        document.getElementById("bestellungHinzufuegen").disabled = false;
    }
    function handleToppingErdbeer(_eventSetTopping) {
    ...
    function handleToppingKeins(_eventSetTopping) {
    ...
    function handleEisSchoko2(_eventSetEis) {
    ...
    function handleEisErdbeere2(_eventSetEis) {
    ...
    function handleEisVanille2(_eventSetEis) {
    ...
    function handleEisHeidelbeere2(_eventSetEis) {
    ...
    function handleEisHaselnuss2(_eventSetEis) {
    ...
    function handleEisSchoko(_eventSetEis) {
    ...
    function handleEisErdbeere(_eventSetEis) {
    ...
    function handleEisVanille(_eventSetEis) {
    ...
    function handleEisHeidelbeere(_eventSetEis) {
    ...
    function handleEisHaselnuss(_eventSetEis) {
    ...
    function handleBehaelterWaffel(_eventSetBehaelter) {
    ...
    function handleBehaelterBecher(_eventSetBehaelter) {
    ...
    function handeleReset(_eventReset) {
        defaultDarstellung();
        hideToppingUndEisButtons();
    }
...
//# sourceMappingURL=KundeScript.js.map